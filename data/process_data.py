...
def load_data(messages_filepath, categories_filepath):
    """ Reads datasets and returns merged dataframe
    ...
    OUTPUT
    df - a dataframe resulting from a merge of the two datasets
    """
...
def clean_data(df):
    """ Performs transformations on dataframe to prepare for usage in machine learning
    
    INPUT
    df - merged dataframe with categories and messages info
    
    OUTPUT
    df - the clean, transformed dataframe
    """
...
def save_data(df, database_filename):
    ...
    INPUT
    df - the clean, transformed dataframe
    database_filename - name for the database in which to save the dataset
